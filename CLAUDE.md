...
- [ ] Создать `powerbi_ontology/chat.py` — класс `OntologyChat`
- [ ] Метод `build_context(ontology)` — формирование контекста из онтологии
- [ ] Метод `ask(question, role)` — отправка вопроса в OpenAI API
- [ ] System prompt с инструкциями для ответов по онтологии
- [ ] Поддержка русского и английского языков

**Фаза 2: Streamlit UI**
- [ ] Добавить 8-ю вкладку "💬 Chat" в `ontology_editor.py`
- [ ] Выбор роли (Admin/Analyst/Viewer) через selectbox
- [ ] История чата в `st.session_state.chat_history`
- [ ] Примеры вопросов (кнопки быстрого ввода)
